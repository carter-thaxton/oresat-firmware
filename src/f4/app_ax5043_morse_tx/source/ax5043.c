...
void ax5043_set_regs(SPIDriver * spip)
{
  ...
  ax5043_write_reg(spip, AX5043_REG_MODULATION, (uint8_t)0x00, ret_value); // Modulation ASK
  ax5043_write_reg(spip, AX5043_REG_ENCODING, (uint8_t)0x00, ret_value);   // No encoding
  ax5043_write_reg(spip, AX5043_REG_FRAMING, (uint8_t)0x06, ret_value);    // No framing
  ...
  ax5043_write_reg(spip, AX5043_REG_TXRATE1, (uint8_t)0x03, ret_value);  
  ax5043_write_reg(spip, AX5043_REG_TXRATE0, (uint8_t)0x47, ret_value);  
  ...
  ax5043_write_reg(spip, AX5043_REG_PKTMAXLEN, (uint8_t)0x80, ret_value);
